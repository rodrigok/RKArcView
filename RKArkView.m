...
-(id<CAAction>)actionForLayer:(CALayer *)layer forKey:(NSString *)event
{
    ...
    {
        CABasicAnimation *boundsAction = (CABasicAnimation *)[self actionForLayer:layer forKey:@"percent"];
        if ([boundsAction isKindOfClass:[CABasicAnimation class]] && [boundsAction.fromValue isKindOfClass:[NSValue class]])
        {
            CABasicAnimation *cornerRadiusAction = [CABasicAnimation animationWithKeyPath:@"percent"];
...
//            CGFloat fromRadius = [self radiusForBounds:fromBounds];
            cornerRadiusAction.fromValue = [NSNumber numberWithFloat:_percent];
